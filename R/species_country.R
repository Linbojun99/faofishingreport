...
#' @examples
#' \dontrun{
#' species_country(FAO34, species_name = "European pilchard(=Sardine)",c(1, 10), plot=TRUE,table=TRUE) #area_data=Fao34
#' }
species_country <- function(area_data, species_name, rank_range = c(1, 10),plot=TRUE,table=TRUE) {
